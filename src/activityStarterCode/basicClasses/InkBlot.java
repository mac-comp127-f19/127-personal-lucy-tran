...
public class InkBlot {
    ...
    public void generateInkBlot() {
        RandomWalk randX = new RandomWalk(150);
        RandomWalk randY = new RandomWalk(150);
        RandomWalk red = new RandomWalk(128);
        RandomWalk green = new RandomWalk(128);
        RandomWalk blue = new RandomWalk(128);

        for (int i = 0; i < 15000; i++) {
            Line line = advance(randX, randY);
            line.setStrokeColor(getColor(red, green, blue));
            canvas.add(line);
        }
